...
def build_argparser():
    ...
    args.add_argument("-v", "--vocab", help="Required. path to the vocabulary file with tokens",
                      required=False, default="vocab.txt", type=str)
    args.add_argument("-m", "--model", default=Path("bert-large-uncased-whole-word-masking-squad-0001.xml"),  help="Required. Path to an .xml file with a trained model",
